...
+ [x] guy why can't we use a higher baud rate than 6M? 
+ [x] guy make a list of amount of data that needs to be transfered
+ [x] guy play with FTDI driver settings, to reduce effect of the FTDI buffer overflow
