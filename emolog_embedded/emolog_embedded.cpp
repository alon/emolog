...
// The following is used to support a timestamp generated by a pre-build step (see TBD in documentation)
// but also allow not running the pre-build step without compilation errors
extern void dummy_use_timestamp();
void __attribute__((weak)) dummy_use_timestamp() {}  // this will be overriden by the generated C file, if it exists
